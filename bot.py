...
class Bot(commands.Bot):
    ...
    @super().command(name='list', help='Lists all Circles')
    ...
    @super().command(name='list open', help='Lists circles with availability')
    ...
    @super().command(name='create', help='Create a new Circle')
